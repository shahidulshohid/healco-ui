...
//       <Container>
//         <div>
//           <h2 className="text-2xl text-[#151515] font-bold mb-1">Schedule An Appointment</h2>
//           <p className="text-lg text-[#667085]">Fill out the form below to request an appointment with a healthcare provider.</p>
...
//               <h4 className="text-[#1A1A1A] text-lg font-semibold mb-2">Doctor Specialty Category</h4>
...
//                   <MdOutlineKeyboardArrowDown size={25} className="text-[#1A1A1A]"/>
//                 </div>
//               </div>
//             </div>
//             {/* Right: Doctor List */}
...
//                   </ul>
//                 ) : (
//                   <p className="text-gray-500 italic">No doctors available in this category.</p>
//                 )
//               ) : (
//                 <p className="text-gray-500 italic">Please select a category.</p>
//               )}
//             </div>
//           </div>
//         </div>
